...
pub async fn debug_log_token(
    state: &State<ServerState>,
    token: BearerToken,
    uid: Uid,
    snapshot: Json<PostSnapshotV2>,
) -> CreateResponse {
    const ANSI_CLEAR_SCREEN: &str = "\x1B[2J\x1B[1;1H";

    // The ANSI terminal codes for the color, green, yellow and red.
    const COLORS: [&str; 3] = ["\x1B[32m", "\x1B[33m", "\x1B[31m"];
    const ASCII_ART: [&str; 3] = [
        "
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢠⣼⣿⣿⣿⣤⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀",
    ...
    let selected_art = (match snapshot.i {
        ..=200 => 0,
        ..=400 => 1,
        _ => 2,
    } + match snapshot.i {
    ...
    println!(
        "{ANSI_CLEAR_SCREEN}{}{}",
        COLORS[selected_art], ASCII_ART[selected_art]
    );
    println!("\nRaw Data:");
...
pub async fn log_with_token(
    state: &State<ServerState>,
    token: BearerToken,
    uid: Uid,
    snapshot: Json<PostSnapshot>,
) -> CreateResponse {
